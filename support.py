...
from reqs import SUPPORT_SITE, SUPPORT_API_KEY, SUPPORT_VERSION, PROJECT_ID_FOR_CLOSED_ISSUE
from redminelib import Redmine

tracker_ids = {'i': 2, 'c': 3, 'e': 1}


def create_new_CLOSED_issue(subject: str, description: str, username: str, tracker_id_in_str: str, elapsed_time: float,
    ...
    issue.project_id = PROJECT_ID_FOR_CLOSED_ISSUE
...
if __name__ == '__main__':
    print(create_new_CLOSED_issue(subject='Test SuppBot', description='Description', username='kashanyan.v',
                                  tracker_id_in_str='c', elapsed_time=0.8, comment='Тестовый коммент'))
